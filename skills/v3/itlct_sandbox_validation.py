...
# 模拟数据 (实际应使用公开数据集)
# 数据来源建议：
# 1. AnAge 动物衰老数据库 (http://genomics.senescence.info/species/)
# 2. BMR 基础代谢率数据
# 3. PCI 扰动复杂性指数 (Casali et al., 2013)
